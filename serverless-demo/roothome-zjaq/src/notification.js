...
// 使用 cmq 所需的鉴权/配置信息
const SECRET_ID = 'AKIDiCTPVTak2fAQuPhNzQimjlZ0ILDv8aon'; // Replace it with your SecretId , 请替换为您的 SecretId
const SECRET_KEY = 'xhDLFuLn7WllY6wXHzg9MZYLsBLRKzJX'; // Replace it with your SecretKey, 请替换为您的 SecretKey
